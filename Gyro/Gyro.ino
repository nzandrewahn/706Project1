...
float gyroZeroVoltage = 510;      // the value of voltage when gyro is zero according to Frankie
...
void setup() {  // put your setup code here, to run once:
  Serial.begin(9600);           // this section is initialize the sensor, find the the value of voltage when gyro is zero
  int i;
  float sum = 0;
